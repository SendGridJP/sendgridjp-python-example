...
message.add_substitution('fullname', '田中 太郎')
message.add_substitution('fullname', '佐藤 次郎')
message.add_substitution('fullname', '鈴木 三郎')
message.add_substitution("familyname", "田中")
message.add_substitution("familyname", "佐藤")
message.add_substitution("familyname", "鈴木")
message.add_substitution("place", "office")
message.add_substitution("place", "home")
message.add_substitution("place", "office")
